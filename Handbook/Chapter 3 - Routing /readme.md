...
```text
Chapter 1
Fortinet Company & Security Fabric
        ↓
Chapter 2
...
Routing Fundamentals
        ↓
Chapter 4
Next FortiGate Theory Topic
        ↓
Future Chapters
Advanced FortiGate Concepts
```
...
> This chapter is intentionally theory-only. Practical configurations and hands-on exercises should be maintained separately under the repository's `Labs/` section.

---

# 📚 References

- Fortinet Handbook Guide
- FortiGate Routing Reference Material
